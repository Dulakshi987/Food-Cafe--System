...
<d>
  ...
  <div class="container">
    ...
    if (isset($_POST["login"])) {
      ...
      require_once "db.php";
      $sql = "SELECT * FROM a_login  WHERE email = '$email'";
      $result = mysqli_query($conn, $sql);
      if (!$result) {
        die("Query failed: " . mysqli_error($conn));
      }
      $a_login = mysqli_fetch_array($result, MYSQLI_ASSOC);
      if ($a_login) {
        if (password_verify($password, $a_login["password"])) {
          session_start();
    ...
    <form action="admin_login.php" method="post">
      ...
      <p class="aregister">Admin Login Form</p>
