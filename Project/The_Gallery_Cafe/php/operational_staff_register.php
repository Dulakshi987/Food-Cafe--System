...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="operational_staff_login.php">Login</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql = "SELECT * FROM o_login WHERE email = ?";
            ...
            if (count($errors) > 0) {
                ...
                $sql = "INSERT INTO o_login (fName, lName, email, password) VALUES (?, ?, ?, ?)";
                if (mysqli_stmt_prepare($stmt, $sql)) {
        ...
        ?>
        <form action="operational_staff_register.php" method="post">
            <p class="aregister">Operational Register Form</p>
